...
export const Modal: React.FC<ModalProps> = ({
	...
	const contentClasses = isFullscreen
		? "w-full h-full"
		: "w-fit max-w-[90vw] mx-auto bg-white dark:bg-gray-900 rounded-3xl";
	...
	const modalContent = (
		<div className="fixed inset-0 z-[100000] flex items-center justify-center">
			...
			{!isFullscreen && (
				<div
					className="fixed inset-0 transition-opacity bg-gray-400/50 backdrop-blur-[32px]"
					onClick={onClose}
					aria-hidden="true"
				></div>
			)}
			...
			<div
				ref={modalRef}
				className={`${contentClasses} ${className} relative transform transition-all max-h-[90vh]`}
