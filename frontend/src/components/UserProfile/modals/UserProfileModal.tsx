			...
			<form className="flex flex-col" onSubmit={handleSubmit}>
				...
				<div className="mb-4">
					...
					<textarea
						...
						className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
						rows={3}
					/>
				</div>
