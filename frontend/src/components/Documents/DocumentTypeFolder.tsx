...
const DocumentTypeFolder: React.FC<DocumentTypeFolderProps> = ({
	type,
	count,
	isActive,
	onClick,
}) => {
	// Define folder icons and colors for each document type
	const getFolderDetails = (docType: DocumentType | "All") => {
		switch (docType) {
			case "Transcript":
				return {
					icon: "school",
...
export default DocumentTypeFolder;
