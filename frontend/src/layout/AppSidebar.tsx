...
const navItems: NavItem[] = [
	...
	},
	{
		...
		subItems: [
			...
			{ name: "Status & Deadlines", path: "/applications/status", pro: false },
		],
	},
	{
		icon: <PageIcon />,
		name: "Documents",
		subItems: [
			{ name: "Upload Documents", path: "/documents/upload", pro: false },
			{ name: "Document Library", path: "/documents/library", pro: false },
		],
	},
	{
		icon: <BoxCubeIcon />,
		...
		subItems: [
			{ name: "Search Schools", path: "/directory/search", pro: false },
		],
	},
	{
		icon: <CalenderIcon />,
