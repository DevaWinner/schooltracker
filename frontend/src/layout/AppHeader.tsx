			...
			<header className="sticky top-0 flex w-full bg-white border-gray-200 z-[60] dark:border-gray-800 dark:bg-gray-900 lg:border-b">
				<div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
						...
						<div className="hidden lg:block pl-12 relative" ref={searchRef}>
							<div className="relative">
								...
								<input
									...
									autoComplete="off" // Add this to disable browser autocomplete
									autoCorrect="off" // Disable autocorrect as well
					...
					<div
						...
						} items-center justify-between w-full gap-10 px-5 py-4 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none`}
					>
						<div className="flex items-center gap-8 2xsm:gap-6">
							{/* <!-- Dark Mode Toggler --> */}
							<ThemeToggleButton />
							{/* <!-- Dark Mode Toggler --> */}
