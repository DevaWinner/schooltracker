	...
	const ApplicationStatsSkeleton = () => (
		<div className="grid grid-cols-1 gap-6 lg:grid-cols-3 animate-pulse">
			{Array(3).fill(0).map((_, index) => (
				<div key={index} className="rounded-xl border border-gray-200 bg-white p-5 dark:border-white/[0.05] dark:bg-white/[0.03]">
						...
						<>
							<div className="grid grid-cols-2 gap-3 mt-6">
								{Array(4).fill(0).map((_, i) => (
									<div key={i} className="rounded bg-gray-100 p-3 dark:bg-gray-800/50">
									...
									{applications.slice(0, 3).map(app => (
										...
										>
											<div className="flex items-center justify-between">
												<div>
													<h4 className="font-medium text-gray-900 dark:text-white">{app.program_name}</h4>
